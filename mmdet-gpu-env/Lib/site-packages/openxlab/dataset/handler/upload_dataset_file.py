...
def upload_file(dataset_repo: str, source_path: str, target_path="", upload_network="cdn"):
    """
    ...
    try:
        ...
        uploader.upload_file(source_path, target_path, upload_network=upload_network)
